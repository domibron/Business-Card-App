...
public class QRGenerator : MonoBehaviour
{
    ...
    {
        core.WriteToFileQR(core.QRCode);
        core.WriteToFileQRText(core.QRText);
    }
    ...
    public void GenQR(string text)
    {
        ...
        Color32[] _convertPixelToTexture = Encode(textToEncode, _storeEncodedTexture.width, _storeEncodedTexture.height);
        _storeEncodedTexture.SetPixels32(_convertPixelToTexture);
        _storeEncodedTexture.Apply();

        core.QRCode = _storeEncodedTexture;
        core.QRText = textToEncode;
